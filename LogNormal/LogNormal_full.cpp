...
cosmobl::lognormal::LogNormal_full::LogNormal_full (const cosmology::Cosmology cosmology, const double redshift_min, const double redshift_max, const int nredshift, const string author)
{
...
cosmobl::lognormal::LogNormal_full::LogNormal_full (const double rmin, const double xMin, const double xMax, const double yMin, const double yMax, const double zMin, const double zMax, const cosmology::Cosmology cosmology, const double redshift_min, const double redshift_max, const int nredshift, const string author)
{
...
cosmobl::lognormal::LogNormal_full::LogNormal_full (const double rmin, const vector<shared_ptr<catalogue::Catalogue>> random, const double pad, const cosmology::Cosmology cosmology, const double redshift_min, const double redshift_max, const int nredshift, const string author)
{
...
void cosmobl::lognormal::LogNormal_full::set_cosmo_function (const cosmology::Cosmology cosmology, const double redshift_min, const double redshift_max, const int nredshift, const string author)
{

  m_cosmology = make_shared<cosmology::Cosmology>(cosmology);
  ...
  for (size_t i=0;i<kk.size();i++)
    Pk.push_back(m_cosmology->Pk(kk[i], m_author, 0, 0.));
...
void cosmobl::lognormal::LogNormal_full::set_grid_parameters ()
{
...
void cosmobl::lognormal::LogNormal_full::set_grid_parameters (const double rmin, const double xMin, const double xMax, const double yMin, const double yMax, const double zMin, const double zMax)
{
  m_rmin = rmin;
...
void cosmobl::lognormal::LogNormal_full::set_grid_parameters (const double rmin, const vector<shared_ptr<catalogue::Catalogue>> random, const double pad)
{
...
void cosmobl::lognormal::LogNormal_full::set_fields (const bool use_random, const bool doRSD)
{
...
void cosmobl::lognormal::LogNormal_full::reset_fields (const bool use_random, const bool doRSD)
{
...
/*
void cosmobl::lognormal::LogNormal_full::write_XiMultipoles(const vector<double> rr, const string file_out)
{
...
void cosmobl::lognormal::LogNormal_full::set_clustering_signal()
{
...
void cosmobl::lognormal::LogNormal_full::set_density_field (const double smoothing_radius)
{
...
void cosmobl::lognormal::LogNormal_full::set_radial_velocity ()
{
  for (int i=0; i<m_nx; i++) {
    double kx = m_clustering_signal->kX(i);
    for (int j=0; j<m_ny; j++) {
...
void cosmobl::lognormal::LogNormal_full::set_visibility ()
{
...
void cosmobl::lognormal::LogNormal_full::set_visibility_from_random ()
{
...
void cosmobl::lognormal::LogNormal_full::set_visibility_from_random_RSD ()
{
...
void cosmobl::lognormal::LogNormal_full::extract_points_lognormal_field (const double nObjects, const bool doRSD, const vector<double> redshift, const vector<double> bias, const shared_ptr<data::Field3D> visibility, const string file_out)
{
...
void cosmobl::lognormal::LogNormal_full::set_potential()
{
...
void cosmobl::lognormal::LogNormal_full::set_displacement_field()
{
...
void cosmobl::lognormal::LogNormal_full::set_rsd_displacement_field()
{
  for (int i=0; i<m_nx; i++) {
