...
namespace cbl {
  ...
  namespace catalogue {
    ...
    protected:
      ...
      /// Coordinates in Eigen array
      cbl::Vector4D m_coordinates;
      ...
      /**
       * @param set internal member m_coordinates
       * @brief set internal member m_coordinates according
       * to object comoving coordinates
       * @return None
       */
      void m_set_coordinates () 
      {
	m_coordinates = {m_xx, m_yy, m_zz, 0.};
      }
	...
	m_set_coordinates();
      ...
      /**
       *  @brief get the member \e m_coordinates
       *  @return the coordinate z of the derived object
       */
      cbl::Vector4D coordinates () const
	...
	m_set_coordinates();
      ...
      { if (region<0) ErrorCBL("Error in Object.h: region must be >0 !", "", "Object.h"); m_region = region; m_set_coordinates(); }
