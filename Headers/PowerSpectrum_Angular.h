...
namespace cbl {   
  ...
  namespace measure {
    ...
    namespace angularpk {
       ...
       * @brief the angular two-point correlation estimator
       */
	 ...
	 *
	 */     
	PowerSpectrum_angular (const catalogue::Catalogue data, const double l_min, const double l_max, const int bandwidth=1);   
