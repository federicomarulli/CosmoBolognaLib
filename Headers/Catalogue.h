...
namespace cbl {
  ...
  namespace catalogue {
	...
	for (auto &&i : sample)
      ...
      Catalogue (const VoidAlgorithm algorithm, const Catalogue halo_catalogue, const std::vector<std::string> file, const double nSub, const int n_rec, const std::string mode, const std::string dir_output, const std::string output, const double rmax, const int cellsize, const int n_iter, const double delta_movement);
