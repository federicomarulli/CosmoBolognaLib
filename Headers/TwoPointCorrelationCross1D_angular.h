...
/**
 *  @file Headers/TwoPointCorrelationCross1D_angular.h
 *
 *  @brief The class TwoPointCorrelationCross1D_angular
 *
...
#ifndef __TWOPOINTCROSSANG__
#define __TWOPOINTCROSSANG__
