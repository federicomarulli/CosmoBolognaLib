...
namespace cbl {
	...
	namespace catalogue {
		 ...
		 *  
		 */
		ChainMeshCell(const comovingCoordinates coord, const int ID=par::defaultInt, const std::vector<unsigned int> part={}, std::vector<std::vector<unsigned int>> nearCells={}) 
			: Object(coord, ID), m_part(part), m_nearCells(nearCells) {}
