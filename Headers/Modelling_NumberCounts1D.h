...
/**
 *  @file Headers/Modelling_NumberCounts1D.h
 *
 *  @brief The class Modelling_NumberCounts1D
 *
 *  This file defines the interface of the class Modelling_NumberCounts1D, 
 *  used to  model 1D number counts
 *
