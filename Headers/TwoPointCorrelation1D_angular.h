...
/**
 *  @file Headers/TwoPointCorrelation1D_angular.h
 *
...
namespace cbl {
  ...
  namespace measure {
    ...
    namespace twopt {
       ...
       *  "Headers/TwoPointCorrelation1D_angular.h"
       *
       *  @brief The class TwoPointCorrelation1D_angular
       *
	 ...
	 *  @return none
	 */
	void set_parameters (const BinType binType, const double thetaMin, const double thetaMax, const double binSize, const double shift, const CoordinateUnits angularUnits=CoordinateUnits::_radians_, std::function<double(double)> angularWeight=nullptr, const bool compute_extra_info=false);
