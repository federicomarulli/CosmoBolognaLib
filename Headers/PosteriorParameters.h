...
namespace cbl {
  ...
  namespace statistics {
    ...
    public:
       ...
       */
      size_t nparameters_free () const override { return m_nparameters_free; }
       ...
       */
      std::vector<unsigned int> free_parameter () const override { return m_free_parameter; }
       ...
       */
      size_t nparameters_fixed () const override { return m_nparameters_fixed; } 
       ...
       * the covariance estimate (Percival et al. 2014):
       *
       * \f[ \sigma_p = \sqrt{\frac{1+B(n_b-n_p)}{1+A+B(n_p+1)}} \,
       * \f]
       *
       * where 
       *
