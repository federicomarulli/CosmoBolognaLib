...
/**
 *  @file Headers/ModelFunction_TwoPointCorrelation2D_polar.h
 *
 ...
 *  model the 2D two-point correlation function in polar coordinates
 *  
...
#ifndef __MODFUNCTWOP2DPOL__
#define __MODFUNCTWOP2DPOL__
