...
namespace cbl {
  ...
  namespace catalogue {
    ...
    public :
       ...
       *
       *  @param dist_function the function that compute the distance (e.g. cbl::Euclidean_distance)
       *
       ...
       *
       */
      CatalogueChainMesh (const std::function<double(double, double, double, double, double, double)> dist_function,  double cellsize, std::shared_ptr<cbl::catalogue::Catalogue> cat);
       ...
       *  @param cat shared_ptr of a catalogue of object to subdivide in the cells of the created catalogue
       * 
       *  @param cat2 shared_ptr of an optional second catalogue of object, given for size the chainmesh
       *
       *  @param cellsize the size of the cells
       *  
       */
      CatalogueChainMesh (const std::function<double(double, double, double, double, double, double)> dist_function,  double cellsize, std::shared_ptr<cbl::catalogue::Catalogue> cat, std::shared_ptr<cbl::catalogue::Catalogue> cat2);
