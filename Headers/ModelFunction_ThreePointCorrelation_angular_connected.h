...
/**
 *  @file
 *  Headers/ModelFunction_ThreePointCorrelation_angular_connected.h
 *
 ...
 *  the connected three-point correlation function in angular
 *  coordinates
 *  
...
#ifndef __MODFUNCTHREEPANGCON__
#define __MODFUNCTHREEPANGCON__
