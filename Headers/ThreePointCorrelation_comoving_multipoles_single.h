...
namespace cbl {
  ...
  namespace measure {
	 ...
	 * approach
	 *
	 * This function computes the multipoles expansion of the
	 * binned triplet counts from a the joined data+random
	 * catalogue. The random catalogue objects are weighted by \f[
	 * \hat{w}_i = -\frac{N_D}{N_R} w_i; \f]
	 *
	 * with \f$ N_D, N_R \f$ the weighted number of data and
	 * random objects and \f$ w_i \f$ the original weight of the
	 * random object.
	 *
	 * The multipoles expansion of triplets in the joined
	 * catalogue corresponds to the numerator of the
	 * Szapudi-Szalay estimator of the three-point correlation
	 * function.
	 *
	 * By looking at negative weights we can compute the
	 ...
	 */
	ThreePointCorrelation_comoving_multipoles_single () = default;

	/**
	 * @brief constructor
	 *
	 * @details constructor of
	 * ThreePointCorrelation_comoving_multipoles_single to compute
	 * single configuration three-point correlation function
	 * multipoles
	 *
