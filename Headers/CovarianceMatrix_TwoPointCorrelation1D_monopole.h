...
/**
 *  @file Headers/CovarianceMatrix_TwoPointCorrelation1D_monopole.h
 *
 *  @brief The class TwoPointCorrelation
 *
 *  This file defines the interface of the class CovarianceMatrix_TwoPointCorrelation1D_monopole,
...
#ifndef __COVMAT_TWOPOINT_MONO__
#define __COVMAT_TWOPOINT_MONO__
...
namespace cbl {
  ...
  namespace measure {
    ...
    namespace covmat {
      ...
      /**
       *  @class CovarianceMatrix_TwoPointCorrelation1D_monopole CovarianceMatrix_TwoPointCorrelation1D_monopole.h
       *  "Headers/CovarianceMatrix_TwoPointCorrelation1D_monopole.h"
       *
       *  @brief The class CovarianceMatrix_TwoPointCorrelation1D_monopole
       *
       *  This is the class used to measure the covariance of two-point
       *  correlation function monopole
       *
       */
      class CovarianceMatrix_TwoPointCorrelation1D_monopole {
        ...
        */
        ...
        std::shared_ptr<cbl::glob::FuncGrid> m_interpXi;
      ...
      public:
         ...
         * @return object of type CovarianceMatrix_TwoPointCorrelation1D_monopole
         */
        CovarianceMatrix_TwoPointCorrelation1D_monopole () {}

       /**
        * @brief Constructor of CovarianceMatrix_TwoPointCorrelation1D_monopole
        * @param random random catalogue
        * @param binType the bin binType
        * @param rMin minimum separation
        * @param rMax maximum separation
        * @param nBins number of bins
        * @param interpXi function to interpolate the xi
        ...
        * @return object of type CovarianceMatrix_TwoPointCorrelation1D_monopole
        */
        CovarianceMatrix_TwoPointCorrelation1D_monopole (const catalogue::Catalogue random,
        ...
        * @return None
        */
        virtual ~CovarianceMatrix_TwoPointCorrelation1D_monopole ()  = default;
