...
namespace cbl {
  ...
  namespace modelling {
	...
	/// Vector of proxy/mass error values
	 ...
	 *  are Gaussian distributions.
       ...
       *
       */
      std::vector<double> model_scaling_relation_with_errors (const std::vector<double> proxy_or_mass, const std::shared_ptr<void> inputs, std::vector<double> &parameter);
