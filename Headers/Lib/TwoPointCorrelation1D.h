...
namespace cosmobl {
  ...
  namespace measure {
	 ...
	 */
	TwoPointCorrelation1D () { m_dataset = data::Data::Create(data::DataType::_1D_data_); }
	 ...
	 */
	vector<double> xi1D () const override { vector<double> vv; m_dataset->data(vv); return vv;  }
