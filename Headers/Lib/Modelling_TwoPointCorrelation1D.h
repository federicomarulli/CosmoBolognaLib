...
namespace cosmobl {
  ...
  namespace modelling {
	 ...
	 *  @return none
	 */
	void set_data_model (const cosmology::Cosmology cosmology={}, const double redshift=0., const string method_Pk="CAMB", const double sigmaNL_perp=0., const double sigmaNL_par=0., const bool NL=true, const double bias=1., const double pimax=40., const double r_min=1., const double r_max=350., const double k_min=1.e-4, const double k_max=100., const int step=500, const string output_root="test", const int norm=-1, const double aa=0., const bool GSL=true, const double prec=1.e-3, const string file_par=par::defaultString, const double Delta=200., const bool isDelta_vir=true, const vector<double> cluster_redshift = {}, const vector<double> cluster_mass_proxy={}, const vector<double> cluster_mass_proxy_error={}, const string method_bias="Tinker", const int seed=744524123);
	 ...
	 *  @return none
	 */
	void set_data_HOD (const cosmology::Cosmology cosmology={}, const double redshift=0., const string author_MF="Tinker", const string author_bias="Tinker", const double Mh_min=0., const double Mh_max=1.e16, const double pi_max=100., const double r_max_int=100., const double r_min=1.e-3, const double r_max=350., const double k_min=0., const double k_max=100., const int step=200, const string method_Pk="CAMB", const bool NL=true, const string output_root="test", const double Delta=200., const double kk=0., const string interpType="Linear", const int norm=-1, const double prec=1.e-2, const string input_file=par::defaultString, const bool is_parameter_file=true, const string author_cM="Duffy", const string profile="NFW", const string halo_def="vir");
	
	 void set_data_model_cluster_selection_function (const cosmology::Cosmology cosmology, const cosmology::Cosmology test_cosmology, const double mean_redshift, const string method_bias, const string method_MF, const string selection_function_file, const vector<int> selection_function_columns={}, const double z_min=par::defaultDouble, const double z_max=par::defaultDouble, const double Mass_min=par::defaultDouble, const double Mass_max=par::defaultDouble, const double Delta=200, const bool isDelta_vir=false, const string method_Pk="CAMB", const double prec=1.e-2, const double k_min=1.e-4, const double k_max=100, const int step=200, const int mass_step=50);
