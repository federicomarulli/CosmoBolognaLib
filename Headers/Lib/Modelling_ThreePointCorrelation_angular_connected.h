...
/**
 *  @file
 *  Headers/Lib/Modelling_ThreePointCorrelation_angular_connected.h
 *
...
public:
	 ...
	 *  Modelling_ThreePointCorrelation_angular_connected
	 */
	Modelling_ThreePointCorrelation_angular_connected (const shared_ptr<cosmobl::measure::threept::ThreePointCorrelation> threep)
	 ...
	 *  Modelling_ThreePointCorrelation_angular_connected
	 */
	Modelling_ThreePointCorrelation_angular_connected (const shared_ptr<data::Data> threep_dataset)
