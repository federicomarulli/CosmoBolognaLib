...
namespace cosmobl {
  ...
  public:
     ...
     *  @return none
     */
    void sum (const shared_ptr<Pairs>, const double ww=1) override;
     ...
     *  @return none
     */
    void put (const shared_ptr<Object>, const shared_ptr<Object>) override;
  ...
  public:
     ...
     *  @return none
     */
    void put_log (const shared_ptr<Object>, const shared_ptr<Object>) override;
  };
}
