...
/**
 *  @file
 *  Headers/Lib/ModelFunction_ThreePointCorrelation_angular_reduced.h
 *
 ...
 *  the reduced three-point correlation function in angular
 *  coordinates
 *  
...
#ifndef __MODFUNCTHREEPANGRED__
#define __MODFUNCTHREEPANGRED__
