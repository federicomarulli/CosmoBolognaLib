...
namespace cosmobl {
  ...
  namespace twopt {
    ...
    protected:
       ...
       */
      shared_ptr<data::Data> MultipolesTwoP (const vector<double> rr, const vector<double> mu, const vector<vector<double> > xi, const vector<vector<double> > error_xi) override;
