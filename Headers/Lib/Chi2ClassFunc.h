...
namespace cosmobl {
  ...
  namespace classfunc {
    ...
    private: 
      ...
      typedef double(*model) (double, void *, vector<double>); // 1D function: y (x, fixed parameters, free parameters)  
      ...
      model func;                          // model
      void *params;                        // fixed parameters of the model
    ...
    public:
      ...
      Chi2Model_1D (vector<double> _xx, vector<double> _fx, model _func, void *_params, vector< vector<double> > _par_limits, bool _ptype=1, int _min=0, int _max=0)
    ...
    public:
      ...
      Chi2Sigma_1D (vector<double> _xx, vector<double> _fx, vector<double> _df, model _func, void *_params, vector< vector<double> > _par_limits, bool _ptype=1, int _min=0, int _max=0)
    ...
    public:
      ...
      Chi2log_1D (vector<double> _xx, vector<double> _fx, vector<double> _df, model _func, void *_params, vector< vector<double> > _par_limits, bool _ptype=1, int _min=0, int _max=0)
	: xx(_xx), fx(_fx), df(_df), func(_func), params(_params), par_limits(_par_limits), ptype(_ptype), min(_min), max((_max>0) ? _max : xx.size()) {} 
    ...
    public:
      ...
      Chi2Cov_1D (vector<double> _xx, vector<double> _fx, vector< vector<double> > _cov_inv, model _func, void *_params, vector< vector<double> > _par_limits, bool _ptype=1, int _min=0, int _max=0)
    ...
    private: 
      ...
      typedef double(*model) (double, double, void *, vector<double>); 
    ...
    public:
      ...
      Chi2Model_2D (vector<double> _xx, vector<double> _yy, vector< vector<double> > _fx, model _func, void *_params, vector< vector<double> > _par_limits, int _min1=0, int _min2=0, int _max1=0, int _max2=0)
    ...
    public:
      ...
      Chi2Sigma_2D (vector<double> _xx, vector<double> _yy, vector< vector<double> > _fx, vector <vector<double> > _df, model _func, void *_params, vector< vector<double> > _par_limits, bool _ptype=1, int _min1=0, int _min2=0, int _max1=0, int _max2=0)
    ...
    public:
      ...
      Chi2log_2D (vector<double> _xx, vector<double> _yy, vector< vector<double> > _fx, vector <vector<double> > _df, model _func, void *_params, vector< vector<double> > _par_limits, bool _ptype=1, int _min1=0, int _min2=0, int _max1=0, int _max2=0)
	: xx(_xx), yy(_yy), fx(_fx), df(_df), func(_func), params(_params), par_limits(_par_limits), ptype(_ptype), min1(_min1), min2(_min2), max1((_max1>0) ? _max1 : _fx.size()), max2((_max2>0) ? _max2 : _fx[0].size()) {} 
