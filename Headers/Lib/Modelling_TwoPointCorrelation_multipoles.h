...
#ifndef __MODELLINGMULT__
#define __MODELLINGMULT__
...
namespace cosmobl {
  ...
  namespace modelling {
     ...
     *
     */
    class Modelling_TwoPointCorrelation_multipoles : public Modelling_TwoPointCorrelation {
    ...
    public:
       ...
       *  @return none
       */
      virtual ~Modelling_TwoPointCorrelation_multipoles () {}
