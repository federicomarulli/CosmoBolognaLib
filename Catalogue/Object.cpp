...
std::shared_ptr<Object> cbl::catalogue::Object::Create (const ObjectType objType, const comovingCoordinates coord, const double weight, const long region, const std::string field, const double x_displacement, const double y_displacement, const double z_displacement)
{
  ...
  else if (objType==ObjectType::_HostHalo_) return move(unique_ptr<HostHalo>(new HostHalo(coord, weight, region, field, x_displacement, y_displacement, z_displacement)));
  else ErrorCBL("Error in cbl::catalogue::Object::Create() in Object.cpp: no such type of object!");
  return NULL;
}
...
std::shared_ptr<Object> cbl::catalogue::Object::Create (const ObjectType objType, const comovingCoordinates coord, const cosmology::Cosmology &cosm, const double z1_guess, const double z2_guess, const double weight, const long region, const std::string field, const double x_displacement, const double y_displacement, const double z_displacement)
{
  ...
  else if (objType==ObjectType::_HostHalo_) return move(unique_ptr<HostHalo>(new HostHalo(coord, cosm, z1_guess, z2_guess, weight, region, field, x_displacement, y_displacement, z_displacement)));
  else ErrorCBL("Error in cbl::catalogue::Object::Create() in Object.cpp: no such type of object!");
  return NULL;
}
...
std::shared_ptr<Object> cbl::catalogue::Object::Create (const ObjectType objType, const observedCoordinates coord, const double weight, const long region, const std::string field, const double x_displacement, const double y_displacement, const double z_displacement)
{
  if (objType==ObjectType::_Random_) return move(unique_ptr<RandomObject>(new RandomObject(coord, weight, region, field, x_displacement, y_displacement, z_displacement)));
  else if (objType==ObjectType::_Mock_) return move(unique_ptr<Mock>(new Mock(coord, weight, region, field, x_displacement, y_displacement, z_displacement)));
  else if (objType==ObjectType::_Halo_) return move(unique_ptr<Halo>(new Halo(coord, weight, region, field, x_displacement, y_displacement, z_displacement)));
...
std::shared_ptr<Object> cbl::catalogue::Object::Create (const ObjectType objType, const observedCoordinates coord, const CoordinateUnits inputUnits, const double weight, const long region, const std::string field, const double x_displacement, const double y_displacement, const double z_displacement)
{
  ...
  else if (objType==ObjectType::_HostHalo_) return move(unique_ptr<HostHalo>(new HostHalo(coord, inputUnits, weight, region, field, x_displacement, y_displacement, z_displacement)));
  else ErrorCBL("Error in cbl::catalogue::Object::Create() in Object.cpp: no such type of object!");
  return NULL;
}
...
std::shared_ptr<Object> cbl::catalogue::Object::Create (const ObjectType objType, const observedCoordinates coord, const cosmology::Cosmology &cosm, const double weight, const long region, const std::string field, const double x_displacement, const double y_displacement, const double z_displacement)
{
  ...
  else if (objType==ObjectType::_HostHalo_) return move(unique_ptr<HostHalo>(new HostHalo(coord, cosm, weight, region, field, x_displacement, y_displacement, z_displacement)));
  else ErrorCBL("Error in cbl::catalogue::Object::Create() in Object.cpp: no such type of object!");
  return NULL;
}
...
std::shared_ptr<Object> cbl::catalogue::Object::Create (const ObjectType objType, const observedCoordinates coord, const CoordinateUnits inputUnits, const cosmology::Cosmology &cosm, const double weight, const long region, const std::string field, const double x_displacement, const double y_displacement, const double z_displacement)
{
  ...
  else if (objType==ObjectType::_HostHalo_) return move(unique_ptr<HostHalo>(new HostHalo(coord, inputUnits, cosm, weight, region, field, x_displacement, y_displacement, z_displacement)));
  else ErrorCBL("Error in cbl::catalogue::Object::Create() in Object.cpp: no such type of object!");
  return NULL;
}
...
std::shared_ptr<Object> cbl::catalogue::Object::Create (const ObjectType objType, const double xx, const double yy, const double zz, const double ra, const double dec, const double redshift, const double weight, const long region, const std::string field, const double x_displacement, const double y_displacement, const double z_displacement)
{
  ...
  else if (objType==ObjectType::_HostHalo_) return move(unique_ptr<HostHalo>(new HostHalo(xx, yy, zz, ra, dec, redshift, weight, region, field, x_displacement, y_displacement, z_displacement)));
  else ErrorCBL("Error in cbl::catalogue::Object::Create() in Object.cpp: no such type of object!");
  return NULL;
}
