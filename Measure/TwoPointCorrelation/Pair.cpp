...
shared_ptr<Pair> cbl::pairs::Pair::Create (const cbl::pairs::PairType type, const cbl::pairs::PairInfo info, const double Min, const double Max, const int nbins, const double shift, const CoordinateUnits angularUnits, FunctionDoubleDouble angularWeight)
{
  if (info==PairInfo::_standard_) {
    ...
    if (type==PairType::_angular_lin_)
      ...
      return move(unique_ptr<Pair1D_comoving_multipoles_lin_extra>{new Pair1D_comoving_multipoles_lin_extra(Min, Max, nbins, shift, angularUnits, angularWeight)});
...
shared_ptr<Pair> cbl::pairs::Pair::Create (const PairType type, const PairInfo info, const double Min, const double Max, const double binSize, const double shift, const CoordinateUnits angularUnits, FunctionDoubleDouble angularWeight)
{
  if (info==PairInfo::_standard_) {
    ...
    if (type==PairType::_angular_lin_)
      ...
      return move(unique_ptr<Pair1D_comoving_multipoles_lin_extra>{new Pair1D_comoving_multipoles_lin_extra(Min, Max, binSize, shift, angularUnits, angularWeight)});
...
shared_ptr<Pair> cbl::pairs::Pair::Create (const cbl::pairs::PairType type, const PairInfo info, const double Min_D1, const double Max_D1, const int nbins_D1, const double shift_D1, const double Min_D2, const double Max_D2, const int nbins_D2, const double shift_D2, const CoordinateUnits angularUnits, FunctionDoubleDouble angularWeight)
{
  if (info==PairInfo::_standard_) {
  
    if (type==PairType::_comovingCartesian_linlin_)
    ...
    else if (type==PairType::_comovingCartesian_linlog_)
    ...
    else if (type==PairType::_comovingCartesian_loglin_)
    ...
    else if (type==PairType::_comovingCartesian_loglog_)
    ...
    else if (type==PairType::_comovingPolar_linlin_)
    ...
    else if (type==PairType::_comovingPolar_linlog_)
    ...
    else if (type==PairType::_comovingPolar_loglin_)
...
shared_ptr<Pair> cbl::pairs::Pair::Create (const cbl::pairs::PairType type, const PairInfo info, const double Min_D1, const double Max_D1, const double binSize_D1, const double shift_D1, const double Min_D2, const double Max_D2, const double binSize_D2, const double shift_D2, const CoordinateUnits angularUnits, FunctionDoubleDouble angularWeight)
{
  if (info==PairInfo::_standard_) {
