...
/** 
 *  @file
 *  Modelling/ThreePointCorrelation/ModelFunction_ThreePointCorrelation_angular_connected.cpp
 *
 ...
 *  model the connected three-point correlation function in angular
 *  coordinates
 *
