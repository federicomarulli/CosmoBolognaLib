...
void cbl::modelling::threept::Modelling_ThreePointCorrelation::set_data_model_zeta_RSD (const double r1, const double r2, const cosmology::Cosmology cosmology, const double redshift, const string method_Pk, const bool NL, const int max_ll, const double k_min, const double k_max, const int step_k, const double r_min, const double r_max, const int step_r, const bool force_realSpace, const bool use_k, const string output_dir, const bool store_output_CAMB, const string output_root, const int norm, const double prec)
{
  ...
  m_data_model.Pk_DM = m_data_model.cosmology->Pk(m_data_model.kk, m_data_model.method_Pk, m_data_model.NL, m_data_model.redshift, m_data_model.output_dir, m_data_model.store_output_CAMB, m_data_model.output_root, m_data_model.norm, m_data_model.k_min, m_data_model.k_max, m_data_model.prec);
}
