...
void cosmobl::modelling::twopt::Modelling_TwoPointCorrelation1D::set_data_model (const cosmology::Cosmology cosmology, const double redshift, const string method_Pk, const double sigmaNL_perp, const double sigmaNL_par, const bool NL, const double bias, const double pimax, const double r_min, const double r_max, const double k_min, const double k_max, const int step, const string output_root, const int norm, const double aa, const bool GSL, const double prec, const string file_par, const double Delta, const bool isDelta_vir, const vector<double> cluster_redshift, const vector<double> cluster_mass_proxy, const vector<double> cluster_mass_proxy_error, const string method_bias, const int seed)
{
  ...
  m_data_model.method_bias = method_bias;
  m_data_model.gau_ran = make_shared<cosmobl::random::NormalRandomNumbers>(cosmobl::random::NormalRandomNumbers(0., 1., seed));
  ...
  if (cluster_mass_proxy.size()>0) {
    ...
    m_data_model.cluster_mass_proxy = make_shared<cosmobl::data::Data1D_extra>(cosmobl::data::Data1D_extra(cl_zz, cluster_mass_proxy, cluster_mass_proxy_error, {cl_sigma})); 
  }
}
...
void cosmobl::modelling::twopt::Modelling_TwoPointCorrelation1D::set_data_HOD (const cosmology::Cosmology cosmology, const double redshift, const string author_MF, const string author_bias, const double Mh_min, const double Mh_max, const double pi_max, const double r_max_int, const double r_min, const double r_max, const double k_min, const double k_max, const int step, const string method_Pk, const bool NL, const string output_root, const double Delta, const double kk, const string interpType, const int norm, const double prec, const string input_file, const bool is_parameter_file, const string author_cM, const string profile, const string halo_def)
{
  m_data_HOD.cosmology = make_shared<cosmology::Cosmology>(cosmology);
  m_data_HOD.redshift = redshift;
  m_data_HOD.author_MF = author_MF;
  m_data_HOD.author_bias = author_bias;
  ...
  m_data_HOD.author_cM = author_cM;
...
void cosmobl::modelling::twopt::Modelling_TwoPointCorrelation1D::write_model (const string dir, const string file, const vector<double> xx, const vector<double> parameter, const int start, const int thin)
{
  ...
  if (parameter.size()==0) {
    ...
    for (size_t i=0; i<rad.size(); i++) 
      fout << rad[i] << "  " << median_model[i] << "  " << low_model[i] << "  " << up_model[i] << endl;
...
void cosmobl::modelling::twopt::Modelling_TwoPointCorrelation1D::set_data_model_cluster_selection_function (const cosmology::Cosmology cosmology, const cosmology::Cosmology test_cosmology, const double mean_redshift, const string method_bias, const string method_MF, const string selection_function_file, const vector<int> selection_function_columns, const double z_min, const double z_max, const double Mass_min, const double Mass_max, const double Delta, const bool isDelta_vir, const string method_Pk, const double prec, const double k_min, const double k_max, const int step, const int mass_step)
{
  m_data_model.cosmology = make_shared<cosmology::Cosmology>(cosmology);
  ...
  m_data_model.method_MF = method_MF;
  m_data_model.method_bias = method_bias;
  ...
  read_matrix(selection_function_file, mass_grid, redshift_grid, selection_function, selection_function_columns);
  m_data_model.interp_SelectionFunction = make_shared<cosmobl::glob::FuncGrid2D>(cosmobl::glob::FuncGrid2D(mass_grid, redshift_grid, selection_function, "Linear"));
  ...
  m_data_model.interp_SelectionFunction_cut = make_shared<cosmobl::glob::FuncGrid>(cosmobl::glob::FuncGrid(mass_grid, sf_monoz, "Spline"));
