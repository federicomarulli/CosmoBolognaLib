...
vector<vector<double>> cosmobl::ccfitswrapper::read_table_fits (const string input_fits, const vector<string> column_names, const int next, const double fill_value)
{
...
void cosmobl::ccfitswrapper::write_table_fits (const string output_dir, const string file_fits, const vector<string> column_names, const vector<vector<double>> table, const vector<string> column_units)
{
