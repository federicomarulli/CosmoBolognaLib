...
int main () {
  ...
  try {
    ...
    std::cout << "The integral is: " << cbl::wrapper::gsl::GSL_integrate_qag(&cbl::gaussian<double>, pp, {mean, sigma}, lower_limit, upper_limit, prec, limit_size, rule) << std::endl;

    // integrating a function of type: function<double<double>>
    std::cout << "The integral is: " << cbl::wrapper::gsl::GSL_integrate_qag(&Gaussian, lower_limit, upper_limit, prec, limit_size, rule) << std::endl;
    ...
    std::cout << "The integral is: " << cbl::wrapper::gsl::GSL_integrate_qag(GaussianL, lower_limit, upper_limit, prec, limit_size, rule) << std::endl;
