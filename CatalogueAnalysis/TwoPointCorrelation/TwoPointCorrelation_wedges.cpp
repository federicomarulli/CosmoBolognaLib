...
void cosmobl::twopt::TwoPointCorrelation_wedges::read_covariance (const string dir, const string file)
{
...
void cosmobl::twopt::TwoPointCorrelation_wedges::write_covariance (const string dir, const string file) const
{
...
void cosmobl::twopt::TwoPointCorrelation_wedges::compute_covariance (const vector<shared_ptr<data::Data>> xi, const bool JK)
{
...
void cosmobl::twopt::TwoPointCorrelation_wedges::compute_covariance (const vector<string> file, const bool JK)
{
