...
{
  add_data1D(i, {ww*pair->PP1D(i), ww*pair->PP1D_weighted(i), ww*pair->scale_mean(i), ww*pair->scale_S(i), ww*pair->z_mean(i), ww*pair->z_S(i)});
}
...
void cosmobl::pairs::Pair1D_extra::Sum (const shared_ptr<Pair> pair, const double ww)
{
