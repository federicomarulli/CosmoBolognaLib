...
shared_ptr<Pair> cosmobl::pairs::Pair::Create (const PairType type, const double Min, const double Max, const int nbins, const double shift)
{
  if (type==_angular_lin_)       return move(unique_ptr<Pair1D_angular_lin>{new Pair1D_angular_lin(Min, Max, nbins, shift)});
  else if (type==_angular_log_)  return move(unique_ptr<Pair1D_angular_log>{new Pair1D_angular_log(Min, Max, nbins, shift)});
  else if (type==_comoving_lin_) return move(unique_ptr<Pair1D_comoving_lin>{new Pair1D_comoving_lin(Min, Max, nbins, shift)});
  else if (type==_comoving_log_) return move(unique_ptr<Pair1D_comoving_log>{new Pair1D_comoving_log(Min, Max, nbins, shift)});
...
shared_ptr<Pair> cosmobl::pairs::Pair::Create (const PairType type, const double Min, const double Max, const double binSize, const double shift)
{
  if (type==_angular_lin_)       return move(unique_ptr<Pair1D_angular_lin>{new Pair1D_angular_lin(Min, Max, binSize, shift)});
  else if (type==_angular_log_)  return move(unique_ptr<Pair1D_angular_log>{new Pair1D_angular_log(Min, Max, binSize, shift)});
  else if (type==_comoving_lin_) return move(unique_ptr<Pair1D_comoving_lin>{new Pair1D_comoving_lin(Min, Max, binSize, shift)});
  else if (type==_comoving_log_) return move(unique_ptr<Pair1D_comoving_log>{new Pair1D_comoving_log(Min, Max, binSize, shift)});
...
shared_ptr<Pair> cosmobl::pairs::Pair::Create (const PairType type, const double Min_D1, const double Max_D1, const int nbins_D1, const double shift_D1, const double Min_D2, const double Max_D2, const int nbins_D2, const double shift_D2)
{
  if (type==_comovingCartesian_linlin_) return move(unique_ptr<Pair2D_comovingCartesian_linlin>{new Pair2D_comovingCartesian_linlin(Min_D1, Max_D1, nbins_D1, shift_D1, Min_D2, Max_D2, nbins_D2, shift_D2)});
  
  else if (type==_comovingCartesian_linlog_) return move(unique_ptr<Pair2D_comovingCartesian_linlog>{new Pair2D_comovingCartesian_linlog(Min_D1, Max_D1, nbins_D1, shift_D1, Min_D2, Max_D2, nbins_D2, shift_D2)});

  else if (type==_comovingCartesian_loglin_) return move(unique_ptr<Pair2D_comovingCartesian_loglin>{new Pair2D_comovingCartesian_loglin(Min_D1, Max_D1, nbins_D1, shift_D1, Min_D2, Max_D2, nbins_D2, shift_D2)});

  else if (type==_comovingCartesian_loglog_) return move(unique_ptr<Pair2D_comovingCartesian_loglog>{new Pair2D_comovingCartesian_loglog(Min_D1, Max_D1, nbins_D1, shift_D1, Min_D2, Max_D2, nbins_D2, shift_D2)});

  else if (type==_comovingPolar_linlin_) return move(unique_ptr<Pair2D_comovingPolar_linlin>{new Pair2D_comovingPolar_linlin(Min_D1, Max_D1, nbins_D1, shift_D1, Min_D2, Max_D2, nbins_D2, shift_D2)});
  
  else if (type==_comovingPolar_linlog_) return move(unique_ptr<Pair2D_comovingPolar_linlog>{new Pair2D_comovingPolar_linlog(Min_D1, Max_D1, nbins_D1, shift_D1, Min_D2, Max_D2, nbins_D2, shift_D2)});

  else if (type==_comovingPolar_loglin_) return move(unique_ptr<Pair2D_comovingPolar_loglin>{new Pair2D_comovingPolar_loglin(Min_D1, Max_D1, nbins_D1, shift_D1, Min_D2, Max_D2, nbins_D2, shift_D2)});

  else if (type==_comovingPolar_loglog_) return move(unique_ptr<Pair2D_comovingPolar_loglog>{new Pair2D_comovingPolar_loglog(Min_D1, Max_D1, nbins_D1, shift_D1, Min_D2, Max_D2, nbins_D2, shift_D2)});
...
shared_ptr<Pair> cosmobl::pairs::Pair::Create (const PairType type, const double Min_D1, const double Max_D1, const double binSize_D1, const double shift_D1, const double Min_D2, const double Max_D2, const double binSize_D2, const double shift_D2)
{
  if (type==_comovingCartesian_linlin_) return move(unique_ptr<Pair2D_comovingCartesian_linlin>{new Pair2D_comovingCartesian_linlin(Min_D1, Max_D1, binSize_D1, shift_D1, Min_D2, Max_D2, binSize_D2, shift_D2)});
  
  else if (type==_comovingCartesian_linlog_) return move(unique_ptr<Pair2D_comovingCartesian_linlog>{new Pair2D_comovingCartesian_linlog(Min_D1, Max_D1, binSize_D1, shift_D1, Min_D2, Max_D2, binSize_D2, shift_D2)});

  else if (type==_comovingCartesian_loglin_) return move(unique_ptr<Pair2D_comovingCartesian_loglin>{new Pair2D_comovingCartesian_loglin(Min_D1, Max_D1, binSize_D1, shift_D1, Min_D2, Max_D2, binSize_D2, shift_D2)});

  else if (type==_comovingCartesian_loglog_) return move(unique_ptr<Pair2D_comovingCartesian_loglog>{new Pair2D_comovingCartesian_loglog(Min_D1, Max_D1, binSize_D1, shift_D1, Min_D2, Max_D2, binSize_D2, shift_D2)});

  else if (type==_comovingPolar_linlin_) return move(unique_ptr<Pair2D_comovingPolar_linlin>{new Pair2D_comovingPolar_linlin(Min_D1, Max_D1, binSize_D1, shift_D1, Min_D2, Max_D2, binSize_D2, shift_D2)});
  
  else if (type==_comovingPolar_linlog_) return move(unique_ptr<Pair2D_comovingPolar_linlog>{new Pair2D_comovingPolar_linlog(Min_D1, Max_D1, binSize_D1, shift_D1, Min_D2, Max_D2, binSize_D2, shift_D2)});

  else if (type==_comovingPolar_loglin_) return move(unique_ptr<Pair2D_comovingPolar_loglin>{new Pair2D_comovingPolar_loglin(Min_D1, Max_D1, binSize_D1, shift_D1, Min_D2, Max_D2, binSize_D2, shift_D2)});

  else if (type==_comovingPolar_loglog_) return move(unique_ptr<Pair2D_comovingPolar_loglog>{new Pair2D_comovingPolar_loglog(Min_D1, Max_D1, binSize_D1, shift_D1, Min_D2, Max_D2, binSize_D2, shift_D2)});
...
void cosmobl::pairs::Pair1D_angular_lin::set_parameters_nbins ()
{
...
void cosmobl::pairs::Pair1D_angular_log::set_parameters_nbins ()
{
  if (m_thetaMin<1.e-30) ErrorMsg("Error in cosmobl::pairs::Pair1D_angular_log::set_parameters_nbins of Pair.cpp: Min must be >0!");
...
void cosmobl::pairs::Pair1D_angular_log::set_parameters_binSize ()
{
...
void cosmobl::pairs::Pair1D_comoving_lin::set_parameters_nbins ()
{
...
void cosmobl::pairs::Pair1D_comoving_log::set_parameters_nbins ()
{
  if (m_rMin<1.e-30) ErrorMsg("Error in cosmobl::pairs::Pair1D_comoving_log::set_parameters_nbins of Pair.cpp: Min must be >0!");
...
void cosmobl::pairs::Pair1D_comoving_log::set_parameters_binSize ()
{
...
void cosmobl::pairs::Pair2D_comovingCartesian_linlin::set_parameters_nbins ()
{
...
void cosmobl::pairs::Pair2D_comovingCartesian_linlog::set_parameters_nbins ()
{
  if (m_piMin<1.e-30)
    ErrorMsg("Error in cosmobl::pairs::Pair2D_comovingCartesian_linlog::set_parameters_nbins of Pair.cpp: m_piMin must be >0!");
...
void cosmobl::pairs::Pair2D_comovingCartesian_linlog::set_parameters_binSize ()
{
  if (m_piMin<1.e-30)
...
void cosmobl::pairs::Pair2D_comovingCartesian_loglin::set_parameters_nbins ()
{
  if (m_rpMin<1.e-30)
    ErrorMsg("Error in cosmobl::pairs::Pair2D_comovingCartesian_loglin::set_parameters_nbins of Pair.cpp: m_rpMin must be >0!");
...
void cosmobl::pairs::Pair2D_comovingCartesian_loglin::set_parameters_binSize ()
{
  if (m_rpMin<1.e-30)
...
void cosmobl::pairs::Pair2D_comovingCartesian_loglog::set_parameters_nbins ()
{
  if (m_rpMin<1.e-30 || m_piMin<1.e-30)
    ErrorMsg("Error in cosmobl::pairs::Pair2D_comovingCartesian_loglog::set_parameters_nbins of Pair.cpp: m_rpMin and m_piMin must be >0!");
...
void cosmobl::pairs::Pair2D_comovingCartesian_loglog::set_parameters_binSize ()
{
  if (m_rpMin<1.e-30 || m_piMin<1.e-30)
...
void cosmobl::pairs::Pair2D_comovingPolar_linlin::set_parameters_nbins ()
{ 
...
void cosmobl::pairs::Pair2D_comovingPolar_linlog::set_parameters_nbins ()
{
  if (m_muMin<1.e-30)
    ErrorMsg("Error in cosmobl::pairs::Pair2D_comovingPolar_linlog::set_parameters_nbins of Pair.cpp: m_muMin must be >0!");
...
void cosmobl::pairs::Pair2D_comovingPolar_linlog::set_parameters_binSize ()
{
  if (m_muMin<1.e-30)
...
void cosmobl::pairs::Pair2D_comovingPolar_loglin::set_parameters_nbins ()
{
  if (m_rMin<1.e-30)
    ErrorMsg("Error in cosmobl::pairs::Pair2D_comovingPolar_loglin::set_parameters_nbins of Pair.cpp: m_rMin must be >0!");
...
void cosmobl::pairs::Pair2D_comovingPolar_loglin::set_parameters_binSize ()
{
  if (m_rMin<1.e-30)
...
void cosmobl::pairs::Pair2D_comovingPolar_loglog::set_parameters_nbins ()
{
  if (m_rMin<1.e-30 || m_muMin<1.e-30)
    ErrorMsg("Error in cosmobl::pairs::Pair2D_comovingPolar_loglog::set_parameters_nbins of Pair.cpp: m_rMin and m_muMin must be >0!");
...
void cosmobl::pairs::Pair2D_comovingPolar_loglog::set_parameters_binSize ()
{
  if (m_rMin<1.e-30 || m_muMin<1.e-30)
...
void cosmobl::pairs::Pair1D_angular_lin::put (const shared_ptr<Object> obj1, const shared_ptr<Object> obj2)
{
  ...
  double tt = angular_distance(x1, x2, y1, y2, z1, z2); 
...
void cosmobl::pairs::Pair2D_comovingCartesian_linlin::put (const shared_ptr<Object> obj1, const shared_ptr<Object> obj2) 
{
  ...
  if (m_rpMin<rp && rp<m_rpMax && m_piMin<pi && pi<m_piMax) {
    ...
    double ww = obj1->weight()*obj2->weight();
