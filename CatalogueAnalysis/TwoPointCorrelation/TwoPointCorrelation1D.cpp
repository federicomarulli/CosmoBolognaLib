...
{  
  ...
  if (PP->pairInfo()==_standard_)
    for (int i=0; i<PP->nbins(); i++) 
      fout << setiosflags(ios::fixed) << setprecision(5) << setw(8) << i << "   " << setw(8) << PP->scale(i) << "   " << setw(13) << PP->PP1D(i) << "   " << setw(13) << PP->PP1D_weighted(i) << endl;
  ...
  // ----- standard + extra info -----
    ...
    for (int i=0; i<PP->nbins(); i++)
      fout << setiosflags(ios::fixed) << setprecision(5) << setw(8) << i << "   " << setw(8) << PP->scale(i) << "   " << setw(13) << PP->PP1D(i) << "   " << setw(13) << PP->PP1D_weighted(i) << "   " << setw(8) << PP->scale_mean(i) << "   " << setw(8) << PP->scale_sigma(i) << "   " << setw(8) << PP->z_mean(i) << "   " << setw(8) << PP->z_sigma(i) << endl;
...
{  
  ...
  if (PP[0]->pairInfo()==_standard_)
	...
	for (int r1=0; r1<PP[index]->nbins(); r1++)
	  if (PP[index]->PP1D(r1)>0)
	    fout << setiosflags(ios::fixed) << setprecision(5) << setw(8) << i << "   " << setw(8) << j << "   " << setw(8) << r1 << "   " << setw(8) << PP[index]->scale(r1) << "   " << setw(8) << PP[index]->PP1D(r1) << "   " << setw(8) << PP[index]->PP1D_weighted(r1) << endl;
      }
  ...
  // ----- standard + extra info -----
	...
	for (int r1=0; r1<PP[index]->nbins(); r1++)
	  if (PP[index]->PP1D(r1)>0)
	    fout << setiosflags(ios::fixed) << setprecision(5) << setw(8) << i << "   " << setw(8) << j << "   " << setw(8) << r1 << "   " << setw(8) << PP[index]->scale(r1) << "   " << setw(8) << PP[index]->PP1D(r1) << "   " << setw(8) << PP[index]->PP1D_weighted(r1) << "   " << setw(8) << PP[index]->scale_mean(r1) << "   " << setw(8) << PP[index]->scale_sigma(r1) << "   " << setw(8) << PP[index]->z_mean(r1) << "   " << setw(8) << PP[index]->z_sigma(r1) << endl;
      }
...
shared_ptr<data::Data> cosmobl::twopt::TwoPointCorrelation1D::correlation_NaturalEstimator (const shared_ptr<pairs::Pair> dd, const shared_ptr<pairs::Pair> rr, const int nData, const double nData_weighted, const int nRandom, const double nRandom_weighted)
{
  ...
  for (int i=0; i<dd->nbins(); i++) {
	...
	ErrorCBL("Error in correlation_NaturalEstimator() of TwoPointCorrelation1D.cpp: there are no random objects in the bin "+conv(i, par::fINT)+"; please, either increase the total number of random objects or enlarge the bin size!");
...
shared_ptr<data::Data> cosmobl::twopt::TwoPointCorrelation1D::correlation_LandySzalayEstimator (const shared_ptr<pairs::Pair> dd, const shared_ptr<pairs::Pair> rr, const shared_ptr<pairs::Pair> dr, const int nData, const double nData_weighted, const int nRandom, const double nRandom_weighted)
{
  vector<double> rad(m_dd->nbins()), xi(m_dd->nbins(), -1.), error(m_dd->nbins(), 1000.);
  ...
  for (int i=0; i<dd->nbins(); i++) {
    ...
    if (dd->PP1D_weighted(i)>0) {
      ...
      if (rr->PP1D_weighted(i)<1.e-30) 
	ErrorCBL("Error in correlation_LandySzalayEstimator() of TwoPointCorrelation1D.cpp: there are no random objects in the bin "+conv(i, par::fINT)+"; please, either increase the total number of random objects or enlarge the bin size!");
...
void cosmobl::twopt::TwoPointCorrelation1D::read_covariance (const string dir, const string file)
{
...
void cosmobl::twopt::TwoPointCorrelation1D::write_covariance (const string dir, const string file) const
{
...
void cosmobl::twopt::TwoPointCorrelation1D::compute_covariance (const vector<shared_ptr<data::Data>> xi, const bool JK)
{
...
void cosmobl::twopt::TwoPointCorrelation1D::compute_covariance (const vector<string> file, const bool JK)
{
